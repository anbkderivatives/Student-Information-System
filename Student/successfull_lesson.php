...
<table class=main_menu>
	...
	<h4><font color="#3300FF"> Successfull Lessons </font></h4>
	...
	<?php
		$sql="
		SELECT DISTINCT *
		FROM successfull_lesson, lesson
		WHERE successfull_lesson.Id_Student = '$Id_User' and successfull_lesson.Id_Lesson = lesson.Id_Lesson
